...
```
PATCH /shop/product/v1/receipt/:id
```
...
```
POST /shop/product/v1/receipt/cancel
```
...
```
DELETE /shop/product/v1/receipt/:id
```
...
```
POST /shop/product/v1/receipt/submit-audit
```
...
```
POST /shop/product/v1/receipt/audit
```
